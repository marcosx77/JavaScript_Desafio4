...
const mostrarCotizaciones = () => {
  ...
  for (const cot of moneda) {
    IdCotiza.innerHTML += `
      <div class="col-md-4 card tarjeta" style="width: 18rem;">
          <img src="../img/moneda${contador}.jpg" class="card-img-top" alt="test">
          <div class="card-body">
              <h5 class="card-title">${cot.nombre} (${cot.sigla})</h5>
              <p class="card-text">
              <b>Compra: ${cot.precioCompra}</b> <br>
              <b>Venta:  ${cot.precioVenta}</b>
...
//ARRAYS DE MONEDAS
const moneda = [];
moneda.push(new MonedaExtranjera("Dolar EEUU", "USD", 318, 320));
